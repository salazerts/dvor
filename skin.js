...
// Pano2VR 5.2.4/15996
// Filename: Dvor.ggsk
// Generated Вт апр 2 20:41:42 2024
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		this._thumbnail_menu.ggTop=-162;
		...
		this._thumbnail_cloner.ggHeight = 153;
	...
	function SkinHotspotClass(skinObj,hotspot) {
		...
		
		{
			...
			this._svg_1__imga=document.createElement('img');
			this._svg_1__imga.className='ggskin ggskin_svg';
			this._svg_1__imga.setAttribute('src',basePath + 'images/svg_1__a.svg');
			this._svg_1__imga.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;visibility:hidden;pointer-events:none;');
			this._svg_1__imga['ondragstart']=function() { return false; };
			this._svg_1.appendChild(this._svg_1__imga);
			...
			this._svg_1.onmousedown=function (e) {
				me._svg_1__imga.style.visibility='inherit';
				me._svg_1__imgo.style.visibility='hidden';
			}
			this._svg_1.onmouseup=function (e) {
				me._svg_1__imga.style.visibility='hidden';
				me._svg_1__imgo.style.visibility='inherit';
			}
	...
	function SkinCloner_thumbnail_cloner_Class(nodeId, parent) {
		...
		this.elementMouseOver=[];
		this.__div=document.createElement('div');
		this.__div.setAttribute('style','position: absolute; left: 0px; top: 0px; width: 98px; height: 153px; visibility: inherit;');
		...
		this._thumbnail_active.ggLeft=-49;
		...
		this._text_1.onmouseover=function (e) {
			me.elementMouseOver['text_1']=true;
		}
		this._text_1.onmouseout=function (e) {
			me.elementMouseOver['text_1']=false;
		}
		this._text_1.ontouchend=function (e) {
			me.elementMouseOver['text_1']=false;
		}
		this._text_1.ggUpdatePosition=function (useTransition) {
			...
			if (this.parentNode) {
				var w=this.parentNode.offsetWidth;
					this.style.left=(this.ggLeft - 3 + w/2) + 'px';
			}
		}
		this._thumbnail_active.appendChild(this._text_1);
